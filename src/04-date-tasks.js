...
function timeSpanToString(startDate, endDate) {
  ...
  const min = (Math.floor(date / 60000) % 60).toString().padStart(2, '0');
  const hour = (Math.floor(date / 3600000) % 60).toString().padStart(2, '0');
  const mSec = (date % 1000).toString().padStart(3, '0');
